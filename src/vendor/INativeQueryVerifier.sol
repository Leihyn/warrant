// VENDORED VERBATIM from @gluwa/usc-contracts@0.1.2 (Attestcoin / Creditcoin).
// Not our work. Copied unmodified so the build has no npm dependency at compile time.
